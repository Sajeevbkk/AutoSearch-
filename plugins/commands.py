...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('PRIVATE BOT', url=f"https://t.me/AdvBotUpdates")
            ]
            ]
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "🤖 Join Your Channel", url=invite_link.invite_link
                )
            ]
        ]
        ...
        await client.send_message(
            ...
            text="**Please Join Your Updates Channel to use Your Bot!**",
...
async def delete(bot, message):
    ...
    if reply and reply.media:
        msg = await message.reply("File ഇപ്പൊ എടുത്ത് കളഞേല്‍ക്കാം...⏳", quote=True)
    else:
