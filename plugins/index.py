...
async def index_files(bot, query):
    ...
    await query.answer('ഈ files ഇപ്പൊ add ചെയ്തേല്‍ക്കാം...⏳', show_alert=True)
    if int(from_user) not in ADMINS:
        await bot.send_message(int(from_user),
                               f'Your Submission for indexing {chat} has been accepted by Pirate Team and will be added soon.',
                               reply_to_message_id=int(lst_msg_id))
    await msg.edit(
        "Starting Indexing",
